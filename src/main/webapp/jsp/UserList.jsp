...
<div class="container-fuild">
        ...
        <form class="form-horizontal" action="/userList" modelAttribute="userList">
...
%>
      ...
      <div class="col-sm-4"><a href="blockuser?id=<%= user.getRegCode() %>"  class="btn btn-primary">Block</a></div>
      </div>
      </td>
       <%}else{ %> 
        <td>
      <div class="form-group">
      <div class="col-sm-4"><a href="unblockuser?id=<%= user.getRegCode() %>"  class="btn btn-primary">Unblock</a></div>
      </div>
      </td>
      <%} %>  
      </tr>
