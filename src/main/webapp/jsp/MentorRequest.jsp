...
<%@page import="com.mentor.MentorOnDemand.model.Mentor"%>
...
<div class="container-fuild">
        ...
        <div class="nav">
            <ul class="nav nav-tabs nav-justified">
                <li><a data-toggle="tab" href="/mentorrequest">Technology</a></li>
                <li><a data-toggle="tab" href="/userList">User</a></li>
                <li><a data-toggle="tab" href="/mentorList">Mentor</a></li>
                <li><a data-toggle="tab" href="#">Payments</a></li>
            </ul>
        </div>
...
%>
      ...
      <div class="col-sm-4"><a href="confirmStatus?id=<%= mentor.getRegCode() %>&userId=<%=user.getRegCode() %>" >
      <%=user.getStatus() %></a></div>
      </div>
      </div></td>  
      </tr>
      <% }%>       
